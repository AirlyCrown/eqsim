...
export declare function addEscapeEventListener(elem: HTMLElement, onEscape: (event: KeyboardEvent) => void, keyCodesGetter?: () => readonly string[]): () => void;
...
export declare function getPrevNextKeys(orientation: Direction, isRtl?: boolean): {
    nextKey: string;
    prevKey: string;
};
