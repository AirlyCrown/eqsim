...
export { intervalAgo, intervalFloor, intervalCeil, intervalPrevious, intervalNext, intervalExtent, intervalRangeCount, intervalRange, intervalRangeNumeric, intervalRangeStartIndex, decodeIntervalValue, encodedToTimestamp, } from './range';
...
export declare function isTimeInterval(value: unknown): value is AgTimeInterval;
export declare function isTimeIntervalUnit(value: unknown): value is AgTimeIntervalUnit;
