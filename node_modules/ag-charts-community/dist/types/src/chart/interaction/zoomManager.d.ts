import type { AxisID, BoxBounds, CartesianAxisDirection, DeepReadonly, DefinedZoomState, MementoOriginator, Scale, ZoomMinMax, ZoomState } from 'ag-charts-core';
import type { AgZoomEventSource, AgZoomRange } from 'ag-charts-types';
import type { EventsHub, ZoomEventSourceDetail, ZoomMemento } from '../../core/eventsHub';
...
export declare class ZoomManager extends BaseManager implements MementoOriginator<ZoomMemento> {
    ...
    toZoomState(coreZoom: DeepReadonly<CoreZoomStateSafeRetrieval>): ZoomState | undefined;
